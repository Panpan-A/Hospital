        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    @endif
                    <form method="GET" action="{{ route('pacientes.index') }}" class="mb-4 d-flex">
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                @foreach($pacientes as $paciente)
                                    <tr>
                                        <td class="px-6 py-4 whitespace-nowrap">{{ $paciente->id_paciente }}</td>
                                        <td class="px-6 py-4 whitespace-nowrap">{{ $paciente->nss }}</td>
                                        <td class="px-6 py-4 whitespace-nowrap">{{ $paciente->nombre }}</td>
                                        <td class="px-6 py-4 whitespace-nowrap">{{ $paciente->apellido_pat }}</td>
                                        <td class="px-6 py-4 whitespace-nowrap">{{ $paciente->apellido_mat }}</td>
                                        <td class="px-6 py-4 whitespace-nowrap">{{ $paciente->fecha }}</td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            <a href="{{ route('pacientes.edit', $paciente) }}" class="btn btn-warning btn-sm me-2">Editar</a>
